...
namespace ConsumirApi_WFormsNetFramework
{
    public partial class Form1 : Form
    {
        ...
        private async void button1_ClickAsync(object sender, EventArgs e)
        {
            ...
            var response1 = await cliente1.PostAsync("http://localhost:5003/api/Autenticacion/Validar", content);
            ...
            var response = await client2.GetAsync("http://localhost:5003/api/Producto/Lista");
